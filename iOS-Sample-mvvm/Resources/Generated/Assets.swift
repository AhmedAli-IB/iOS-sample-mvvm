...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let icArrow = ImageAsset(name: "ic-arrow")
    internal static let icSearch1 = ImageAsset(name: "ic_Search-1")
    ...
    internal static let icFieldsCircle = ImageAsset(name: "ic_fields-circle")
    internal static let icFields = ImageAsset(name: "ic_fields")
    ...
    internal static let icOnlineCircleUnselected = ImageAsset(name: "ic_online-circle-unselected")
    internal static let icOnlineCricleSelected = ImageAsset(name: "ic_online-cricle-selected")
    internal static let icOnline = ImageAsset(name: "ic_online")
  ...
  internal enum ColorPalette {
    ...
    internal static let descriptionColor = ColorAsset(name: "Description-color")
    ...
    internal static let smeGray = ColorAsset(name: "SME-Gray")
    internal static let smeLightGray = ColorAsset(name: "SME-Light-Gray")
    internal static let smeBlack = ColorAsset(name: "SME-black")
    internal static let screenBackground = ColorAsset(name: "Screen-background")
    internal static let seaBlue = ColorAsset(name: "Sea blue")
    internal static let selectedColor = ColorAsset(name: "Selected-color")
    internal static let steelBlue = ColorAsset(name: "Steel blue")
    internal static let titleColor = ColorAsset(name: "Title-color")
    internal static let unselectedColor = ColorAsset(name: "Unselected-color")
    internal static let weakDatTextColor = ColorAsset(name: "Weak-dat-text-color")
